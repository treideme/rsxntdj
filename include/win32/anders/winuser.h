...
#define MOD_ON_KEYUP 0x800
#define MOD_IGNORE_ALL_MODIFIER 0x400
...
typedef struct tagEVENTMSG {
	...
	DWORD time;
	HWND hwnd;
} EVENTMSG,*PEVENTMSGMSG,*LPEVENTMSGMSG;
...
LPSTR WINAPI CharPrevA(LPCSTR);
LPWSTR WINAPI CharPrevW(LPCWSTR);
