...
#if (!defined(_WCHAR_T) && !defined(_WCHAR_T_DEFINED) && !defined(_WCHAR_T_)) || defined(__need_wchar_t)
...
typedef TCHAR *LPTCH,*PTSTR,*LPTSTR,*LP;
...
typedef WORD LANGID;
/*FIXME: Which version of BC supports __int64? */
#ifdef __GNUC__
#define HAVE_INT64
