...
speed_t cfgetispeed (__const__ struct termios *);
speed_t cfgetospeed (__const__ struct termios *);
...
int tcsetattr (int, int, __const__ struct termios *);

#if defined (__cplusplus)
}
#endif

#endif /* not _TERMIOS_H */
